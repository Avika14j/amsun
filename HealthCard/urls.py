...
from django.conf.views.urls import url
...
#Admin Url
    ...
    path('admin_view_diagnosis', admin_view_diagnosis, name="admin_view_diagnosis"),
    path('diagnosis_status<int:pid>', diagnosis_status, name="diagnosis_status"),
...
#Patient Url
    ...
    path('view_need_help',view_need_help,name="view_need_help"),
    path('send_diagnosis_report',send_diagnosis_report,name="send_diagnosis_report"),
    path('delete_need_help<int:pid>',delete_need_help,name="delete_need_help"),
...
#Doctor Url
    ...
    path('accept_help<int:pid>', accept_help, name="accept_help"),
    path('new_need_help', new_need_help, name="new_need_help"),
    path('help_record', help_record, name="help_record"),
...
#Diagnosis Url
    path('diagnosis_change_password', Diagnosis_Change_Password, name="diagnosis_change_password"),
    path('diagnosis_dashboard', diagnosis_dashboard, name="diagnosis_dashboard"),
    path('diagnosis_profile', Diagnosis_Profile, name="diagnosis_profile"),
    path('diagnosis_patient_search_by_id', diagnosis_patient_search_by_id, name="diagnosis_patient_search_by_id"),
    path('new_diagnosis_report', new_diagnosis_report, name="new_diagnosis_report"),
    path('view_diagnosis_report', view_diagnosis_report, name="view_diagnosis_report"),
    path('dignostic_invoices<int:pid>', dignostic_invoices, name="dignostic_invoices"),



    path('doctor_profile<int:pid>', doctor_profile, name="doctor_profile"),
    path('admin_view_diagnosis_report', admin_view_diagnosis_report, name="admin_view_diagnosis_report"),

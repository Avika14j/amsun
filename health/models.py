...
class Help_Record(models.Model):
    hospital = models.ForeignKey(Hospital, on_delete=models.CASCADE, null=True, blank=True)
    patient = models.ForeignKey(Patient, on_delete=models.CASCADE, null=True, blank=True)
    helper_doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, null=True, blank=True)
    ...
    def __str__(self):
        return self.patient.user.username+" "+self.helper_doctor.user.username

class Diagnosis_Report(models.Model):
    hospital = models.ForeignKey(Hospital, on_delete=models.CASCADE, null=True, blank=True)
